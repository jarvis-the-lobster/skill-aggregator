          ...
          <div className="flex items-center gap-8">
            ...
            {user ? (
              <div className="flex items-center gap-3">
                {user.avatar_url ? (
                  <img src={user.avatar_url} alt={user.name || user.email} className="w-8 h-8 rounded-full object-cover" />
                ) : (
                ...
                <StreakBadge />
                <button onClick={handleLogout} className="text-slate-400 hover:text-slate-100 transition-colors" title="Sign out">
